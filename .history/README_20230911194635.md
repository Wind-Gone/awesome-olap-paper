...
### Join Order
1. [Join Order Selection with Deep Reinforcement Learning:
Fundamentals, Techniques, and Challenges](https://www.vldb.org/pvldb/vol16/p3882-yan.pdf) [VLDB 2023]
2. [Efficiently Computing Join Orders with Heuristic Search](TODO) [SIGMOD 2023]
3. [Detecting Logic Bugs of Join Optimizations in DBMS](TODO) [SIGMOD 2023]
4. [Ready to Leap (by Co-Design)? Join Order Optimisation on Quantum Hardware](TODO) [SIGMOD 2023]
...
### View
1. [Foreign Keys Open the Door for Faster Incremental View Maintenance]([TODO](https://dl.acm.org/doi/pdf/10.1145/3588720)) [SIGMOD 2023]
