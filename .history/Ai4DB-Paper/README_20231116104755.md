...
4. [Learned cardinality estimation: A design space exploration and a comparative evaluation](https://dbgroup.cs.tsinghua.edu.cn/ligl/papers/vldb22-card-exp.pdf) [(VLDB 22)[https://github.com/postechdblab/learned-cardinality-estimation]]
