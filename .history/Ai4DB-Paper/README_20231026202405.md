...
4. [Efficient Join Order Selection Learning with Graph-based Representation](https://zheng-kai.com/paper/kdd_2022_chen.pdf) [SIGKDD 22]
5. [ADOPT: Adaptively Optimizing Attribute Orders for Worst-Case Optimal Join Algorithms via Reinforcement Learning](https://www.vldb.org/pvldb/vol16/p2805-wang.pdf) [[VLDB 23](https://github.com/jxiw/ADOPT/blob/main/)]
6. [SkinnerDB: Regret-bounded Query Evaluation via Reinforcement Learning](https://arxiv.org/pdf/1901.05152.pdf)
