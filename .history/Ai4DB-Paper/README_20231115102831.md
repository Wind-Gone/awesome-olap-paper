...
6. [AutoCE: An Accurate and Efficient Model Advisor for Learned Cardinality Estimation]([todo](https://dbgroup.cs.tsinghua.edu.cn/ligl/papers/AutoCE_camera_ready_ICDE2023.pdf)) [ICDE 23]
7. [ALECE: An Atention-based Learned Cardinality Estimator for SPJ Queries on Dynamic Workloads](https://www.vldb.org/pvldb/vol17/p197-li.pdf) [VLDB 24]
