...
### Cost Model
1. [Efficient Deep Learning Pipelines for Accurate Cost Estimations Over Large Scale Query Workload](https://arxiv.org/pdf/2103.12465.pdf) []

### Survey
1. [Have query optimizers hit the wall?]() [VLDB Journal 2022]
2. [Cardinality Estimation in DBMS: A Comprehensive Benchmark Evaluation]() []
3. [Cardinality Estimation: An Experimental Survey]() []
