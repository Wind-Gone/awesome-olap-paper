...
## HTAP
### MVCC
1. [Rethinking serializable multiversion concurrency control]() [VLDB 15]
2. [Scalable Garbage Collection for In-Memory MVCC Systems]() [15]
3. [Rethink the Scan in MVCC Databases](https://dl.acm.org/doi/pdf/10.1145/3448016.3452783) [SIGMOD 21]
### Log Replay
